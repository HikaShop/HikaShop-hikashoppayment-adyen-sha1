...
class plgHikashoppaymentAdyen extends hikashopPaymentPlugin
{
	...
	function onAfterOrderConfirm(&$order, &$methods, $method_id)
	{
		...
		//required data for adyen platform
	...
	/**
	 * Split Street Number from billing adress
	 */
	...
	/**
	 * set the specific configuration (back end) default values
	 */
	...
	/**
	 * treatment on response information from Ayden servers
	 */
	function onPaymentNotification(&$statuses)
	{
		//filtered array from the parameters received
		$vars = array();
		...
		//TWe load the parameters of the plugin
		...
		if ($this->payment_params->debug)
		{
			//debug information stored in the payment log file
